...
const BookingDetails = () => {
  ...
  else if (activityBookings.length === 0 && selectedTab === "activity")
    return (
      <>
        <TouristNavBar />
        <Error404
  ...
  else if (itineraryBookings.length === 0 && selectedTab === "itinerary")
    return (
      <>
        <TouristNavBar />
        <Error404
  ...
  else if (flightsBookings.length === 0 && selectedTab === "flight")
    return (
      <>
        <TouristNavBar />
        <Error404
  ...
  else if (hotelsBookings.length === 0 && selectedTab === "hotel")
    return (
      <>
        <TouristNavBar />
        <Error404
    ...
    >
      ...
      >
        <div style={{ overflowY: "visible", height: "100vh" }}>
          ...
          {(selectedTab === "Transportation" || selectedTab === "All") && (
            <div>
              {" "}
              <Typography
                variant="h5"

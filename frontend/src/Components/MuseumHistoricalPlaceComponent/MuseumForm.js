...
// function MuseumForm() {  // Capitalized the component name
...
import { message, Select } from 'antd'; // Importing Select from Ant Design
...
function MuseumForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('museumName', museumName);
        formData.append('museumCategory', museumCategory);
        formData.append('tags', tags); // Convert array to JSON
        formData.append('createdBy', createdBy);

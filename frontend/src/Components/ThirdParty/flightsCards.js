...
const FlightsCards = ({ flights }) => {
    ...
    flights.forEach(flight => {
        ...
        const flightKey = `${departureDate}-${arrivalDate}`;
    ...
    return (
        <Box sx={{ flexGrow: 1, mt: 4, overflowY: 'auto' }}>
            <Box sx={{ flexGrow: 1, mt: 4, overflowY: 'auto', backgroundImage: 'airplaneBG.jpg', backgroundSize: 'cover' }}>
                ...
                {uniqueFlights.map((flight, index) => (
                    ...
                    <Card sx={{ borderRadius: 5, width: '100%', height: '100%', boxShadow: '0 8px 16px 0 rgba(0,0,0,0.2)', backgroundColor: '#f5f5f5', position: 'relative' }}>
                        <CardContent sx={{ padding: 2 }}>
                        <Box sx={{ position: 'absolute', top: 8, right: 8 }}>
                            <img src="planeLogo.png" alt="Plane Logo" style={{ width: 40, height: 40 }} />
                        </Box>

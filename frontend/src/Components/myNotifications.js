...
//function to handle the marking of notifications as read
...
return (
    ...
    >
        ...
        <Tooltip title="Mark as read">
            <IconButton color="primary" onClick={() => handleMarkAsRead(notification._id)} sx={{ width: 40, height: 40, margin: 5 }}>

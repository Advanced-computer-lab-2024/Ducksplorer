...
// //Delete a booking of a tourist from the database when he wants to delete his account
...
//         const bookings = await Bookings.find({ user: userName });

//         if (!bookings.length) {
//             return res.status(404).json({ message: "No bookings for this tourist found." });
//         }
